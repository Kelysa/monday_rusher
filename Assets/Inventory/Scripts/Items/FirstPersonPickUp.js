...
function OnGUI ()
{
	...
	if (canPickUp == true)
	{
		...
		{
		    GUI.Box (Rect (Screen.width*0.5-(165*0.5), 200, 165, 22), "Press E pour prendre la " + transform.name + ".");
		}
		else
		{
		    GUI.Box (Rect (Screen.width*0.5-(185*0.5), 200, 185, 22), "Press E pour prendre la " + transform.name + ".");
		}
	}
}
